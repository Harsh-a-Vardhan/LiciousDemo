...
The controller and the service layer add various methods(CRUD) to the the objects by extending the object repositories and using MySQL to store the entities on tables.
